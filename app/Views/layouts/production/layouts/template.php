...
<body
  ...
  <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
    ...
    <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
        ...
        <div
          ...
          <div
            ...
            <div
              ...
              <?= $this->renderSection('toolbar_inventory'); ?>
              ...
              <div
                ...
                <div
                    ...
                    <div class="menu-content d-flex align-items-center px-3">
                      ...
                      <div class="d-flex flex-column min-w-0"><!-- 👈 min-w-0 permite que el flex-item se encoja -->
                        <div class="fw-bold fs-5 text-truncate">
                          <?= esc(session('production_user')['nombre']) ?>
                        </div>
                        <a href="#"
                          class="fw-semibold text-muted text-hover-primary fs-7 text-truncate">
                          <?= esc(session('production_user')['email']) ?>
                        </a>
                      </div>
                      <!--end::Username-->
                  ...
                  <div class="menu-item px-5">
                    <a
                      href="<?= base_url('api/production/auth/logout') ?>"
      ...
      <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
        ...
        <?= view('layouts/production/layouts/sidebar'); ?>
          ...
          <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
              ...
              <div
                ...
                <?= $this->renderSection('content_production'); ?>
  ...
  <?= $this->renderSection('scripts_production'); ?>
