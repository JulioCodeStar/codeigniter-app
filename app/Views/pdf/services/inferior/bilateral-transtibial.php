...
<head>
    <meta charset="UTF-8">
    <title>Ficha de Evaluación Bilateral Transtibial</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>FICHA DE EVALUACIÓN BILATERAL TRANTIBIAL</h1>
        </div>
        ...
        <div class="section">
            ...
            <table class="checkbox-table">
                <tr>
                    ...
                    <td class="checkbox-item">
                        <input type="checkbox" id="rec-estetica">
                        <label for="rec-estetica">Rodiller. TALLA: _______</label>
                    </td>
                    <td class="checkbox-item">
                        <input type="checkbox" id="rec-estetica">
