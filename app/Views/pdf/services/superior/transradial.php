...
<body>
    <div class="container">
        <div class="header">
            <h1>FICHA DE EVALUACIÓN TRANSRADIAL</h1>
        </div>
        ...
        <div class="section">
            ...
            <table class="eval-table">
                ...
                <tr>
                    <td class="eval-label">4. Longitud del dedo Medio:</td>
                    <td class="">______________________________________________</td>
                </tr>
                <tr>
                    <td class="eval-label">5. Circunferencia de la Palma:</td>
                    <td class="">______________________________________________</td>
                </tr>
            </table>
        </div>
        ...
        <div class="section">
            ...
            <table class="eval-table">
                <tr>
                    <td class="eval-label">( ) Mecánica de TPU</td>
                    <td class="eval-label">( ) Mecánica con guante cosmético y arneses</td>
                </tr>
                <tr>
                    <td class="eval-label">( ) Mioeléctrica</td>
                    <td class="eval-label">( ) Biónica</td>
                </tr>
                <tr>
                    <td class="eval-label">( ) Estética</td>
                </tr>
            </table>
        </div>
