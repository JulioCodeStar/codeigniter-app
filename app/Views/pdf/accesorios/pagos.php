...
<body>
    <div class="container">
        ...
        <div class="data-compact">
            ...
            <p>Fecha de Venta: <strong><?= $fecha_inicio ?></strong></p>
            <p>N° de Boleta: <strong><?= $n_boleta ?></strong></p>
        </div>
        ...
        <div class="data-compact">
            ...
            <p>Por el pago de <strong><?= $trabajo ?></strong>.</p>
