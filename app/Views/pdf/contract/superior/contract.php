...
<body>
    <div class="container">
        ...
        <div class="new-page">
            ...
            <div class="data-compact">
                <strong>NOVENA: PROCESO DE ELABORACIÓN, CARACTERISTICAS, INTERVENCIONES QUIRUJICAS, PROGRAMACIÓN DE CITAS, USOS Y CUIDADOS</strong>

                <strong>Proceso de Elaboración:</strong>
                <p>La elaboración de la prótesis abarca un periodo de 30 a 40 días hábiles, distribuidos en 5 fases:</p>

                <ul>
                    <li>Fase I: Toma de medidas y model.</li>
                    <li>Fase II: Pruebas de encaje del socket.</li>
                    <li>Fase III: Pruebas con el prototipo de la prótesis.</li>
                    <li>Fase IV: Modificaciones y ensamble de la prótesis final.</li>
                    <li>Fase V: Entrega de la prótesis final con sus accesorios.</li>
                </ul>

                <strong>Características de las Prótesis:</strong>

                <p>Las prótesis accionadas por el cuerpo ofrecen la capacidad de realizar diversas actividades cotidianas, desde sujetar objetos como vasos, tazas, hasta manipular bolígrafos y teléfonos celulares. La efectividad en estas tareas puede variar en función del nivel de destreza y habilidad individual del paciente.</p>

                <strong>Intervenciones Quirúrgicas y Puntualidad:</strong>

                <p>El paciente no debe realizarse ninguna intervención quirúrgica durante la elaboración de la
                    prótesis para evitar retrasos y variaciones en el diseño del encaje.</p>
                <p>A partir de la FASE III, la empresa no asume responsabilidad por variaciones en medidas del muñón no informadas previamente.</p>

                <strong>Programación de Citas:</strong>

                <p>La asistencia puntual a todas las citas programadas con el especialista es de vital importancia durante las diversas fases del desarrollo hasta la entrega final de la prótesis. La falta de asistencia a estas citas puede ocasionar retrasos considerables en la entrega del producto final. Se informa al paciente que la ausencia continua y no justificada a dichas citas podría resultar en la terminación unilateral del contrato por parte del proveedor, sin derecho a reclamos o reembolsos de los pagos efectuados hasta la fecha de rescisión.</p>

                <strong>Usos y cuidados:</strong>

                <p>El uso de la prótesis se limita a actividades cotidianas que incluyen sujetar vasos, tazas, bolígrafos, teléfonos celulares y objetos similares. Queda expresamente prohibido exponer la prótesis a temperaturas superiores a 50 °C. Se advierte al usuario que la capacidad de carga de la prótesis está limitada a objetos de hasta 1.5 kg, evitando cargas superiores para preservar su integridad y funcionamiento óptimo. Soporta caídas de hasta de 1.5 metros. Adicionalmente, se insta al usuario a evitar el contacto con sustancias químicas, ya que podrían comprometer la integridad y durabilidad de la prótesis.</p>
            </div>
        ...
        <div class="new-page">
            <div class="data-compact">
                <strong>DÉCIMA: GARANTÍA</strong>

                <?php if ($mayor_edad == 'No') { ?>
                    <p>En caso de que se presente alguna falla en algún componente de la prótesis KYP BIO INGEN SAC, nos comprometemos a evaluar dicho componente defectuoso para determinar el origen del problema. Si la falla se debe a defectos de fabricación, procederemos a reemplazarlo por uno nuevo. Sin embargo, no nos haremos responsables por fallas debido a un uso inadecuado o falta de cuidado de la prótesis. En esos casos, se requerirá el pago del componente dañado para realizar el reemplazo.</p>
                    <p>KYP BIO INGEN SAC otorgará el servicio de mantenimiento de hasta un (01) año respecto a la prótesis materia de contrato siempre y cuando la misma no haya sufrido ningún daño estructural que permita su normal funcionamiento por parte de <strong>EL REPRESENTANTE LEGAL</strong>.</p>
                <?php } else { ?>
                    <p>En caso de que se presente alguna falla en algún componente de la prótesis KYP BIO INGEN SAC, nos comprometemos a evaluar dicho componente defectuoso para determinar el origen del problema. Si la falla se debe a defectos de fabricación, procederemos a reemplazarlo por uno nuevo. Sin embargo, no nos haremos responsables por fallas debido a un uso inadecuado o falta de cuidado de la prótesis. En esos casos, se requerirá el pago del componente dañado para realizar el reemplazo.</p>
                    <p>KYP BIO INGEN SAC otorgará el servicio de mantenimiento de hasta un (01) año respecto a la prótesis materia de contrato siempre y cuando la misma no haya sufrido ningún daño estructural que permita su normal funcionamiento por parte de <strong>EL CLIENTE</strong>.</p>
                <?php } ?>
            </div>

            <div class="data-compact">
                <strong>DÉCIMA PRIMERA: RESOLUCIÓN DEL CONTRATO</strong>
                <?php if ($mayor_edad == 'No') { ?>
                    <p>KYP BIO INGEN SAC se encuentra facultado a resolver el presente Contrato, durante la vigencia del mismo, bastando para ello que curse una comunicación simple con cinco (05) días de anticipación a la fecha en que solicita opere la resolución, en caso se dé el incumplimiento a las obligaciones estipuladas en el presente Contrato y/o en la hoja de requerimiento del servicio por parte de <strong>EL REPRESENTANTE LEGAL</strong>.</p>
                <?php } else { ?>
                    <p>KYP BIO INGEN SAC se encuentra facultado a resolver el presente Contrato, durante la vigencia del mismo, bastando para ello que curse una comunicación simple con cinco (05) días de anticipación a la fecha en que solicita opere la resolución, en caso se dé el incumplimiento a las obligaciones estipuladas en el presente Contrato y/o en la hoja de requerimiento del servicio por parte de <strong>EL CLIENTE</strong>.</p>
                <?php } ?>
            </div>

            <div class="data-compact">
                <strong>DÉCIMA SEGUNDA: NOTIFICACION EN DOMICILIO Y/O CORREO ELECTRONICO </strong>
            ...
            <div class="data-compact">
                <strong>DÉCIMA TERCERA: COMPETENCIA Y LEGISLACIÓN</strong>
            ...
            <div class="data-compact">
                <strong>DÉCIMA CUARTA: CLAÚSULA DE NO DEVOLUCIÓN</strong>
        ...
        <div class="new-page">
            ...
            <div class="data-compact">
                <strong>DÉCIMA QUINTA: DISPOSICIONES FINALES</strong>
                ...
                <p>Cualquier modificación o ampliación de los términos del presente Contrato deberá realizarse
                    por escrito y con participación de las partes. </p>
                <p>En señal de conformidad, las partes suscriben el presente documento en dos (2) ejemplares
                    originales en los mismos términos y con la misma validez, en la ciudad de <?= $sede ?> el <?= fecha_spanish($contract_date) ?>.</p>
            </div>
        ...
        <div class="new-page">
            ...
            <div class="data-compact">
                ...
                <p>Además, se me ha proporcionado información detallada sobre los procedimientos específicos que implicarán contacto físico, así como los riesgos y beneficios asociados. Así mismo me explicaron el uso de la media compresiva (media formadora) de ser necesario, su limpieza, manera de colocarla y que el material del cual está fabricado es silicona americana hipoalergénica y si podría producir algún tipo de enrojecimiento es por el tipo de piel que el usuario presenta (sensibilidad, alergia u otro factor) y es de mi completa responsabilidad.</p>

                <p>Entiendo el hecho de que mi muñon varié de volumen con el tiempo debido a factores como el peso corporal, la alimentación, enfermedades de base, entre otros, lo cual podría requerir ajustes en el socket o la fabricación de uno nuevo. Asimismo, al momento de tener el socket final si necesita cambios o uno nuevo <strong>DEBERÉ ASUMIR EL COSTO DE ESTE SOLO SI FUERA NECESARIO.</strong> He tenido oportunidad de hacer preguntas y todas ellas han sido respondidas satisfactoriamente.</p>
