  ...
  <div class="card-header border-0 pt-6">
    ...
    <div class="card-title">
      ...
      <div class="d-flex align-items-center position-relative my-1">
        ...
        <input type="text" data-kt-patient-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Buscar Permiso" />
      </div>
      <!--end::Search-->
    </div>
    <!--begin::Card title-->
    ...
    <div class="card-toolbar">
      ...
      <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
        <a type="button" class="btn btn-primary" href="<?= base_url('patient/new') ?>">
          <i class="ki-duotone ki-plus fs-2"></i>Agregar Permiso</a>
      </div>
      <!--end::Toolbar-->
    </div>
    <!--end::Card toolbar-->
