...
<head>
    <base href="<?= base_url('') ?>" />
    <title>Inventario - Login | KYP Bioingeniería</title>
    <meta charset="utf-8" />
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        <!--begin::Form-->
                        <?= form_open('api/inventory/auth/login', ['id' => 'kt_form_login_inventory', 'class' => 'form w-100', 'novalidate' => 'novalidate']) ?>
                        <!--begin::Heading-->
                        <div class="text-center mb-11">
                            <!--begin::Title-->
                            <h1 class="text-gray-900 fw-bolder mb-3">Inventario</h1>
                            <!--end::Title-->
                            <!--begin::Subtitle-->
            ...
            <div
                ...
                style="
                    ...
                    url(<?= base_url('assets/media/img/img-inventory.jpg') ?>) center/cover no-repeat;
                ">
                ...
                <div class="d-flex flex-column flex-center text-center text-white w-100 h-100 p-5">
                    ...
                    <p class="mt-2 fs-6 text-white">
                        Control y seguimiento eficiente de tu stock en tiempo real.
                    </p>
                </div>
            </div>
            <!--end::Aside-->
