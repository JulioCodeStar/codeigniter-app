              ...
              <div class="py-1">
                ...
                <div id="kt_all_pagos_<?= $index + 1 ?>" class="collapse show fs-6 ps-10">
                  ...
                  <div class="text-muted">
                        <a href="<?= base_url('api/accesorios/generate/pagos/' . $row['referencia_id'] . '/' . $row['pago_nro']) ?>" target="_blank" class="fw-bold text-gray-600 text-hover-primary me-2">Ver Recibo</a>
                      </div>
