...
<?= form_open('api/consentimiento/create', ['id' => 'kt_consen_form', 'class' => 'fv-row mt-5', 'autocomplete' => 'off']) ?>
        ...
        <div class="card" data-kt-sticky="true" data-kt-sticky-name="invoice" data-kt-sticky-offset="{default: false, lg: '200px'}" data-kt-sticky-width="{lg: '250px', lg: '300px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
            <div class="card-body p-10">
                <div class="mb-10 fv-row">
                    ...
                    <input type="date" class="form-control form-control-solid" name="fecha_entrega" id="fecha_entrega" required />
                </div>
...
<script>
    const KTAppCartaConsen = (function() {
        ...
        const init = () => {
            form = document.querySelector("#kt_consen_form");
    ...
    const form_data = document.querySelector('#kt_consen_form');
