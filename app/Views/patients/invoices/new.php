...
<?= form_open('api/invoice/create', ['id' => 'kt_invoice_form', 'class' => 'fv-row', 'autocomplete' => 'off']) ?>
      ...
      <div class="card-body p-12">
        ...
        <div class="d-flex flex-column align-items-start flex-xxl-row">
          ...
          <div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Fecha de Cotización">
            ...
            <div class="position-relative d-flex align-items-center w-150px fv-row">
              ...
              $fecha_actual = (new DateTime())
                ->format('Y-m-d');
              ?>
              <input type="date" class="form-control form-control-transparent fw-bold pe-5" placeholder="Select date" name="fecha_now" id="fecha_now" value="<?= $fecha_actual ?>" />
              <!--end::Datepicker-->
            </div>
            <!--end::Input-->
          </div>
          ...
          <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4">
            <span class="fs-2x fw-bold text-gray-800">Cotización</span>
          </div>
          <!--end::Input group-->
          <!--begin::Input group-->
          <div class="d-flex align-items-center justify-content-end flex-equal order-3 fw-row" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Fecha de Expiración">
            ...
            <div class="position-relative d-flex align-items-center w-150px fv-row">
              ...
              <input type="date" class="form-control form-control-transparent fw-bold pe-5" placeholder="Select date" name="fecha_exp" id="fecha_exp" value="<?= $fecha_vencimiento ?>" />
              <!--end::Datepicker-->
            </div>
            <!--end::Input-->
          </div>
        ...
        <div class="mb-0">
              ...
              <tbody>
                <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                  <td class="pe-7 d-flex flex-column gap-2">
                    ...
                    <input type="text" class="form-control  form-control-solid" name="description[]" id="description[]" placeholder="Description" />
                  </td>
                  <td class="ps-0">
                    <input class="form-control form-control-solid" type="number" min="1" name="cantidad[]" id="cantidad[]" placeholder="1" value="1" data-kt-element="quantity" />
                  </td>
              ...
              <tfoot>
                  ...
                  <th colspan="2" class="border-bottom border-bottom-dashed ps-0">
                    <div class="d-flex flex-column align-items-start fv-row">
                      ...
                      <div class="form-check form-switch mb-4">
                        <input class="form-check-input" type="checkbox" id="igv" name="igv">
                        <label class="form-check-label" for="igv">Agregar IGV (18%)</label>
                      </div>
                      <div class="d-flex align-items-center gap-2 ">
                        <label class="form-label mb-0">Descuento (%)</label>
                        <input type="number" id="descuento" name="descuento" class="form-control form-control-sm w-100px" placeholder="%" min="0" max="100" step="0.01">
                      </div>
                    </div>
                  </th>
                  <th colspan="1" class="border-bottom border-bottom-dashed text-end">
                    <div class="mb-3 fv-row">
                      <input type="text" id="subtotal" class="form-control w-100px form-control-solid mb-4" name="subtotal" placeholder="0.00" />
                    </div>
                    <div class="text-muted small mb-6">IGV: <span id="monto-igv">0.00</span></div>
                    <input type="hidden" readonly name="igv_coti" id="igv_coti">
                    <div class="text-muted small">Descuento: <span id="monto-descuento">0.00</span></div>
                    <input type="hidden" readonly name="descuento_coti" id="descuento_coti">
                  </th>
                </tr>
                <tr class="align-top fw-bold text-gray-700">
                  ...
                  <th colspan="2" class="text-end fs-4 text-nowrap">
                    ...
                    <input type="hidden" readonly name="total_coti" id="total_coti">
                  </th>
                </tr>
              </tfoot>
              <!--end::Table foot-->
          ...
          <div class="mb-2">
            ...
            <textarea name="diagnostico" id="diagnostico" class="form-control form-control-solid " rows="3" placeholder="(Cotización)"></textarea>
          </div>

          <div class="mb-0">
            <label class="form-label fs-6 fw-bold text-gray-700">Ajustes Técnicos</label>
            <textarea name="ajustes" id="ajustes" class="form-control form-control-solid " rows="3" placeholder="(Contrato)"></textarea>
          </div>
          <!--end::Notes-->
        </div>
        <!--end::Wrapper-->
      ...
      <div class="card-body p-10">
        ...
        <div class="mb-8">
          ...
          <div class="fv-row mb-4">
            ...
            <input type="text" class="form-control form-control-solid mb-3" name="encargado" id="encargado" placeholder="Encargado Cotización" />
          </div>
        ...
        <div class="mb-0">
          <button type="submit" href="#" class="btn btn-primary w-100" id="kt_invoice_submit_button">
            ...
            <span class="indicator-progress">
              Cotizando... <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
            </span>
          </button>
...
<script>
  ...
  // Activar los eventos dinámicos al cargar el DOM
