...
Mantenimientos - KYP Bioingeniería
<?= $this->endSection(); ?>
...
<div class="col-xl-12">
  <div class="card">
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-title">
        ...
        <div class="d-flex align-items-center position-relative my-1">
          ...
          <input type="text" data-kt-managment-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Buscar Citas" />
        </div>
        <!--end::Search-->
      </div>
      <!--begin::Card title-->
      ...
      <div class="card-toolbar">
        ...
        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
          ...
          <a type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#ModalManagment">
            <i class="ki-duotone ki-plus fs-2">
              <span class="path1"></span>
              <span class="path2"></span>
            </i>Agregar Mantenimiento
          </a>
    ...
    <div class="card-body">
      <!--begin::Table-->
      <table class="table align-middle table-row-dashed fs-6 gy-5" id="tblManagment">
        <!--begin::Table head-->
        <thead class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
          <tr>
            ...
            <th class="" style="width: 350px; white-space: nowrap;">Descripción</th>
              ...
              <td class="text-end">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                  ...
                  <div class="menu-item px-3">
                    <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#eliminarManagmentModal" data-bs-url="<?= base_url('api/sales/managment/delete/') . $row['id'] ?>">
                      Eliminar
                    </a>
                  </div>
                  <!--end::Menu item-->
                  ...
                  <div class="menu-item px-3">
                    <a href="<?= base_url('sales/managment/generate/' . $row['id']) ?>" target="_blank" class="menu-link px-3">
                      Pdf
                    </a>
                  </div>
                </div>
...
<div class="modal fade" tabindex="-1" id="ModalManagment">
  <div class="modal-dialog modal-dialog-centered mw-650px">
    <?= form_open('api/sales/managment/create', ['id' => 'kt_form_managment', 'class' => 'fv-row modal-content', 'autocomplete' => 'off']) ?>

    <div class="modal-header">
      <h3 class="modal-title">Agregar Nuevo Mantenimiento</h3>
    ...
    <div class="modal-body">
      ...
      <div class="row g-4">
        ...
        <div class="col-md-8 mb-4 fv-row">
          ...
          <select name="paciente" id="paciente" aria-label="Select a Patient" data-control="select2" data-dropdown-parent="#ModalManagment" data-placeholder="Select an option" data-allow-clear="true" class="form-select">
            <option value=""></option>
            <?php foreach ($contract as $row) { ?>
              <option value="<?= $row['id_paciente'] . '|' . $row['id'] ?>"><?= mb_strtoupper($row['nombres'] . ' ' . $row['apellidos']) . ' - ' . mb_strtoupper($row['trabajo']) ?></option>
            <?php } ?>
          </select>
        </div>
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-primary" id="kt_btn_submit_managment">
...
<div class="modal fade" tabindex="-1" id="eliminarManagmentModal" aria-hidden="true">
...
<script>
  const KTDatatables = function() {
    ...
    const initDatatable = () => {
      dt_managment = $("#tblManagment").DataTable({
        searchDelay: 500,
        responsive: true,
        processing: true,
        order: [
  ...
  const eliminarPagosModal = document.querySelector("#eliminarManagmentModal");
  ...
  const form = document.querySelector("#kt_form_managment");
  ...
  const submitButton = document.querySelector('#kt_btn_submit_managment');
