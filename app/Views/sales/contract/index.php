      ...
      <ul
        ...
        <li class="nav-item p-0 ms-0 me-8">
          ...
          <a
            ...
            <!--begin::Title-->
            <span class="nav-text fw-semibold fs-4 mb-3">Pagos (<?= esc($numPagos) ?>)</span>
            <!--end::Title-->
            <!--begin::Bullet-->
            <span
        ...
        <li class="nav-item p-0 ms-0 me-8">
          ...
          <a
            ...
            <!--begin::Title-->
            <span class="nav-text fw-semibold fs-4 mb-3">Contratos (<?= esc($numContract) ?>)</span>
            <!--end::Title-->
            <!--begin::Bullet-->
            <span
              class="bullet-custom position-absolute z-index-2 w-100 h-2px top-100 bottom-n100 bg-primary rounded"></span>
              ...
              <?php foreach ($pagos as $index => $row) { ?>
                <tr>
                  ...
                  <td class="d-flex flex-column">
                    ...
                    <p class="text-muted"><?= $row['trabajo'] ?></p>
                  </td>
                  <td class="">
                  ...
                  <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                      ...
                      <div class="menu-item px-3">
                        <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#eliminarPagosModal" data-bs-url="<?= base_url('api/sales/contract/pagos/delete/') . $row['id'] ?>">
                          Eliminar
                        </a>
                      ...
                      <div class="menu-item px-3">
                        <a href="<?= base_url('sales/contract/generate/pagos/') ?><?= $row['referencia_id'] ?>/<?= $row['pago_nro'] ?>" target="_blank" class="menu-link px-3">
                          Pdf
                        </a>
                      </div>
                    </div>
                ...
                <tr>
                  ...
                  <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                      ...
                      <!--begin::Menu item-->
                      <div class="menu-item px-3">
                        <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#eliminarContratoModal" data-bs-url="<?= base_url('api/sales/contract/delete/') . $row['id'] ?>">
                          Eliminar
                        </a>
                      </div>
                      <!--end::Menu item-->
...
<!--begin::Eliminar Contratos-->
<div class="modal fade" tabindex="-1" id="eliminarContratoModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content position-absolute">
      <div class="modal-header">
        <h5 class="modal-title">Aviso</h5>
...
<script>
  ...
  const eliminarContractModal = document.querySelector("#eliminarContratoModal");
