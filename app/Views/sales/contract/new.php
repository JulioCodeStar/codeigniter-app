...
<div class="card card-flush h-lg-100 mt-6">
  <div class="card-header pt-7">
    <div class="card-title">
      <i class="ki-duotone ki-package fs-1 me-2">
  ...
  <div class="card-body pt-5">
    <?= form_open('api/sales/contract/create', ['id' => 'kt_form_contract', 'class' => 'fv-row', 'autocomplete' => 'off']) ?>
    ...
    <button id="kt_submit_form_contract" type="button" class="btn btn-primary">
...
<script>
  ...
  const form = document.querySelector("#kt_form_contract");
  ...
  const submit = document.querySelector("#kt_submit_form_contract");
