...
Pagos Ventas - KYP BIOINGENIERIA
    ...
    <ul
      ...
      <li class="breadcrumb-item text-muted">
        <a
          ...
          class="text-muted text-hover-primary">Ventas | Pagos</a>
      </li>
      <!--end::Item-->
      <!--begin::Item-->
          ...
          <div class="card-toolbar">
            ...
            <div class="modal fade" tabindex="-1" id="kt_modal_new_pagos">
              <div class="modal-dialog modal-dialog-centered mw-650px">
                <?= form_open('api/sales/accesorios/create_pago', ['id' => 'kt_form_pagos', 'class' => 'fv-row modal-content', 'autocomplete' => 'off']) ?>
  ...
  <div
    ...
    <div
      ...
      <div class="card-body pt-0 fs-6">
        ...
        <div class="mb-10">
          <!--begin::Title-->
          <h5 class="mb-3">Fecha de la Venta</h5>
          <!--end::Title-->
          <!--begin::Details-->
          <div class="mb-0">
            <!--begin::Card info-->
...
<script>
  $(document).ready(function() {
    $("#paciente").on('change', function() {
      ...
      if (id_contract) {
        $.ajax({
          url: `<?= base_url('api/sales/accesorios/getDataAccesorios/') ?>${id_contract}`,
          type: 'GET',
          dataType: 'json',
