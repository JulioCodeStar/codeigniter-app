...
Seguimiento | Caja Ventas - KYP Bioingeniería
<?= $this->endSection(); ?>
...
<div
  ...
  <?= form_open('api/sales/seguimiento/get-data', ['class' => 'row align-items-center justify-content-between gx-3 fv-row', 'id' => 'kt_form_seguimiento']) ?>
  <div class="col-auto d-flex align-items-center gap-3">
    ...
    <div class="w-300px">
      <?php $fecha_actual = (new DateTime())->format('Y-m-d'); ?>
      <input
        type="text"
        class="form-control"
        value="<?= fecha_spanish($fecha_actual) ?>"
        disabled />
    </div>
  </div>
  ...
  <!-- Botón a la derecha -->
  <div class="col-auto">
    <button type="button" class="btn btn-primary fw-bold" id="kt_btn_buscar">
      ...
      <span class="indicator-progress">
        Buscando... <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
      </span>
    </button>
  </div>
  <?= form_close() ?>
...
<script>
  ...
  const frm = document.querySelector("#kt_form_seguimiento");
